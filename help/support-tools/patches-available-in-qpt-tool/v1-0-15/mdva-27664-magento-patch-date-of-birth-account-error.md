...
이 패치는 [품질 패치 도구(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.0.15가 설치된 경우에 사용할 수 있습니다. 이 문제는 Adobe Commerce 버전 2.3.6에서 해결되었습니다.
...
1. 관리자에 로그인합니다.
1. 사용자에 대해 **Locale** = *en\_GB*(영국)을 설정합니다.
1. 고객을 편집합니다.
