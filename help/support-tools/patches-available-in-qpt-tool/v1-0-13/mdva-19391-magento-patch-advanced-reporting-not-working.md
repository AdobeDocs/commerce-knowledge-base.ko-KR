...
MDVA-19391 패치는 PageBuilderAnalytics 모듈의 오류로 인해 고급 보고를 사용할 수 없는 문제를 해결합니다. 이 패치는 [품질 패치 도구(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.0.13이 설치된 경우에 사용할 수 있습니다. 현재 Adobe Commerce에는 이 패치 외에 계획된 솔루션이 없습니다.
...
1. 관리 사이드바에서 **보고서**&#x200B;를 선택합니다.
1. 그런 다음 **Business Intelligence**&#x200B;에서 **고급 보고**&#x200B;를 선택합니다.

<u>예상 결과</u>:

예상대로 **고급 보고** 보고서를 로드해야 합니다.

<u>실제 결과</u>:

*404 찾고 있는 항목을 찾을 수 없습니다.* 오류 페이지가 나타납니다.
