...
description: MDVA-30862 패치는 PDF 송장에 잘못된 주문 날짜가 인쇄되는 문제를 해결합니다. 이 패치는 [Quality Patches Tool (QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.6이 설치된 경우 사용할 수 있습니다. 패치 ID는 MDVA-30862입니다. 이 문제는 Adobe Commerce 2.4.0에서 해결되었습니다.
...
MDVA-30862 패치는 PDF 송장에 잘못된 주문 날짜가 인쇄되는 문제를 해결합니다. 이 패치는 [품질 패치 도구(QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.6이 설치된 경우에 사용할 수 있습니다. 패치 ID는 MDVA-30862입니다. 이 문제는 Adobe Commerce 2.4.0에서 해결되었습니다.
