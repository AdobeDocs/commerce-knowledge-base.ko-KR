...
MDVA-35569 패치는 상태가 장바구니에 지정될 때 GraphQL에 FPT(고정 제품 세금)가 표시되지 않을 때 문제를 해결합니다. 이 패치는 [품질 패치 도구(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.19가 설치된 경우에 사용할 수 있습니다. 패치 ID는 MDVA-35569입니다. 이 문제는 Adobe Commerce 버전 2.4.3에서 해결되었습니다.
...
1. FPT를 활성화합니다.
1. 특성을 만듭니다(예: *weee\_tax*).
1. *weee\_tax* 특성이 추가된 테스트 제품(예: *weetax*)을 만듭니다.
1. FPT를 *weee\_tax* 특성의 캘리포니아 또는 다른 주에 할당하십시오.
1. GraphQL에서 고객을 만듭니다.
1. GraphQL에서 장바구니를 만듭니다.
1. GraphQL을 사용하여 *weetax* 제품을 장바구니에 추가합니다.
1. 장바구니를 쿼리합니다.
