...
[Adobe Commerce 도움말 센터](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)에서 [지원 티켓을 제출](https://support.magento.com). 티켓이 WAF 서비스와 관련되어 있음을 나타내고 차단된 요청 ID(ID)를 포함하십시오.
