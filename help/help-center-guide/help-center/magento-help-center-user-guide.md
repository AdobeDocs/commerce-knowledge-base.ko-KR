...
>1. 사례를 제출할 때 **[!UICONTROL Select a product]** 드롭다운이 비어 있으면 Adobe Commerce 파트너 계정을 사용할 수 있습니다. 지원 권한이 있는 판매자의 [공유 액세스](#shared-access)가 있는 사용자만 티켓을 제출할 수 있습니다. 판매자 문제의 경우 공유 액세스를 요청하십시오. 파트너 문제에 대해서는 spphelp@adobe.com으로 문의하십시오.
...
1. 왼쪽 메뉴에서 **[!UICONTROL Open Ticket]**&#x200B;을(를) 클릭하거나 **[!UICONTROL Get Started]** 카드에서 *[!UICONTROL Open a support ticket]*&#x200B;을(를) 클릭합니다.
...
>
>다른 제품을 선택할 수 없는 경우(예: **제품 선택** 드롭다운이 비어 있거나 표시되지 않음) 일반적으로 다음 이유 중 하나로 인해 발생합니다.
>
...
왼쪽 메뉴에서 **[!UICONTROL My Cases]**&#x200B;을(를) 클릭하여 개인적으로 제출한 Commerce 사례를 볼 수 있습니다. &quot;(Commerce)&quot;로 끝나는 올바른 조직을 선택했는지 확인하십시오.

![지원 사례 보기](assets/view_support_cases.png)

#### Adobe Commerce 도움말 센터에서 이전 사례 보기

Adobe Commerce 기술 자료의 **Adobe Commerce 도움말 센터 제거**&#x200B;에 있는 Adobe Commerce 도움말 센터에서 [이전 사례를 보기](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/announcements/news/decommissioning-of-adobe-commerce-help-center)하는 방법에 대해 자세히 알아보세요.

#### 시청한 사례 보기

왼쪽 메뉴에서 *을(를) 클릭하여*&#x200B;감시자로 추가&#x200B;**[!UICONTROL My organization's cases]**&#x200B;한 Commerce 사례를 볼 수 있습니다.
...
1. 화면 오른쪽에 있는 **[!UICONTROL Escalate to management]** 패널의 오른쪽 하단에 있는 *[!UICONTROL Case Detail]*&#x200B;을(를) 클릭합니다.
...
서비스 케이스를 닫으려면 **[!UICONTROL Close case]** 패널의 오른쪽 하단에 있는 *[!UICONTROL Case Detail]*&#x200B;을(를) 클릭합니다.
...
>[!NOTE]
>
>닫힌 티켓에서 이메일 알림에 응답하면 사례를 다시 열 수 없습니다. 서비스 케이스를 다시 열려면 계정 소유자가 [공유 액세스](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26164)를 부여했는지 확인하세요.
...
1. 공유 액세스를 취소할 사용자를 찾아 해당 사용자의 행(![작업](assets/remove_icon.png){width="25"} 열)에서 **제거 아이콘**&#x200B;을 클릭합니다.
...
1. 공유 액세스를 취소할 사용자를 찾아 해당 사용자의 행(**[!UICONTROL Edit]** 열)에서 *[!UICONTROL Actions]*&#x200B;을(를) 클릭합니다.
