...
>[!NOTE]
>
>Adobe Commerce 지원 기술 자료 가이드가 곧 재구성되어 콘텐츠가 Adobe Experience League 내의 다른 위치로 이동됩니다. 당분간은 이 안내서의 콘텐츠를 계속 유지 관리하고 업데이트할 예정입니다.
...
| [도움말 센터 사용 안내서](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) | 지원 티켓을 관리하고, 공유 액세스 권한을 부여하고, 기술 자료를 효과적으로 탐색하는 방법에 대해 알아봅니다. |
