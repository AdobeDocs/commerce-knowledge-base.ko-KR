...
2. **[!UICONTROL Magento]** > **[!UICONTROL My Products and Services]** > **[!UICONTROL Magento Business Intelligence]**&#x200B;을(를) 클릭하고 업데이트할 라이선스 옆에 있는 **[!UICONTROL Show Details]**&#x200B;을(를) 클릭합니다.
3. **[!UICONTROL Update Payment Method]** 또는 **[!UICONTROL Cancel License]**&#x200B;을(를) 선택하십시오.
