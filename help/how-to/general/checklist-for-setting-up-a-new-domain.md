...
즉, 이전에 `ece-tools` 패키지에서 `config:dump` 명령을 실행하여 빌드[&#128279;](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/develop/deploy/static-content#setting-the-scd-on-build)에서 SCD를 설정했습니다.
