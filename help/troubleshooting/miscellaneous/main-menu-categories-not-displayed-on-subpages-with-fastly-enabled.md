...
이 문서에서는 Fastly 또는 Vannish가 활성화된 경우 기본 메뉴(또는 사용자 안내서의 [카테고리 상단 탐색 메뉴](https://experienceleague.adobe.com/docs/commerce-admin/catalog/catalog/navigation/navigation-top.html?lang=ko))가 하위 페이지(예: *블로그/페이지*)의 상점 앞에 표시되지 않는 경우에 대한 수정 사항을 제공합니다.
...
Fastly 또는 기타 바니시 기반 서비스를 사용하는 경우 기본 메뉴(사용자 안내서에서는 [범주 위쪽 탐색 메뉴](https://experienceleague.adobe.com/docs/commerce-admin/catalog/catalog/navigation/navigation-top.html?lang=ko)라고도 함)가 하위 페이지의 상점 앞에 표시되지 않습니다.
...
* [검색 엔진 최적화](https://experienceleague.adobe.com/docs/commerce-admin/catalog/categories/create/categories-search-engine-optimization.html?lang=ko)
* [새 페이지 추가](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/pages/page-add.html?lang=ko)

페이지 계층 구조:

* [개요](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/pages/page-hierarchy.html?lang=ko)
* [노드 추가](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/pages/page-hierarchy.html?lang=ko#add-a-hierarchy-node)
