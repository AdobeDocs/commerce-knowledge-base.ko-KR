...
1. 여전히 로그인할 수 없는 경우 с 개발자 설명서에서 **클라우드 프로젝트 > 프로젝트에 사용자 추가**&#x200B;에 설명된 대로 프로젝트의 라이선스 소유자 또는 슈퍼 사용자에게 연락하여 [프로젝트 수준 사용자](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/project/user-access.html#add-a-user-to-the-project)로 액세스 권한을 제공했는지 확인하십시오.
