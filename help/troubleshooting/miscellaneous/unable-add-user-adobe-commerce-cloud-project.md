...
참고: 사용자가 2022년 8월 이전에 account.magento.com 또는 accounts.magento.cloud에 계정이 있는 경우 2022년 8월 또는 그 이후에 계정을 만들지 않았다면 adobe.com에 계정이 없을 수도 있습니다. 사용자에게 Adobe 계정이 있어 로그인할 수 없는 경우 자세한 내용을 포함하여 [Grp-Magento-HelpCenterLoginIssues@adobe.com](mailto:Grp-Magento-HelpCenterLoginIssues@adobe.com)(으)로 전자 메일을 보내십시오.
